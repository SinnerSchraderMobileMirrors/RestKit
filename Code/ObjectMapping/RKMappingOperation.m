...
- (BOOL)applyRelationshipMappings
{
    ...
    for (RKRelationshipMapping *relationshipMapping in [self relationshipMappings]) {
        ...
        // The @"." keyPath indicates that we want to map directly from the parent representation
        id value = [relationshipMapping.sourceKeyPath isEqualToString:@"."] ? self.sourceObject : [self.sourceObject valueForKeyPath:relationshipMapping.sourceKeyPath];
